...
async function fetchExchangeRate(currencyCode) {
  ...
  try {
    ...
    if (typeof krwRate !== "number" || !isFinite(krwRate))
...
const THEME_PRESETS = {
  ...
  dark: {
    ...
    "--t-danger": "#F87171",
    "--t-border": "#2D3340",
    "--t-border-light": "#1E2330",
    "--t-shadow": "0 1px 3px rgba(0,0,0,0.3)",
    "--t-shadow-lg": "0 8px 24px rgba(0,0,0,0.5)",
  },
  spring: {
    "--t-bg": "#FFF5F8",
    "--t-bg-card": "#FFFFFF",
    ...
    "--t-text-white": "#FFFFFF",
    "--t-primary": "#D81B60",
    "--t-primary-light": "#FCE4EC",
    "--t-primary-dark": "#880E4F",
    "--t-success": "#43A047",
    "--t-warning": "#FB8C00",
    "--t-danger": "#E53935",
    "--t-border": "#F8BBD9",
    "--t-border-light": "#FFD6EA",
    "--t-shadow": "0 1px 3px rgba(216,27,96,0.1)",
    "--t-shadow-lg": "0 8px 24px rgba(216,27,96,0.18)",
  },
  summer: {
    "--t-bg": "#EFF6FF",
    "--t-bg-card": "#FFFFFF",
    ...
    "--t-danger": "#DC2626",
    "--t-border": "#93C5FD",
    "--t-border-light": "#DBEAFE",
    "--t-shadow": "0 1px 3px rgba(37,99,235,0.08)",
    "--t-shadow-lg": "0 8px 24px rgba(37,99,235,0.15)",
  },
  fall: {
    "--t-bg": "#FFF8F0",
    "--t-bg-card": "#FFFDF9",
    ...
    "--t-text-white": "#FFFFFF",
    "--t-primary": "#E64A19",
    "--t-primary-light": "#FBE9E7",
    "--t-primary-dark": "#BF360C",
    "--t-success": "#558B2F",
    "--t-warning": "#F9A825",
    "--t-danger": "#B71C1C",
    "--t-border": "#FFCCBC",
    "--t-border-light": "#FBE9E7",
    "--t-shadow": "0 1px 3px rgba(230,74,25,0.08)",
    "--t-shadow-lg": "0 8px 24px rgba(230,74,25,0.15)",
  },
  winter: {
    "--t-bg": "#F0F3F8",
    "--t-bg-card": "#FFFFFF",
    ...
    "--t-text-white": "#FFFFFF",
    "--t-primary": "#3F6FD8",
    "--t-primary-light": "#E4EAF4",
    "--t-primary-dark": "#2952B3",
    "--t-success": "#2E7D6B",
    "--t-warning": "#A07D20",
    "--t-danger": "#B91C1C",
    "--t-border": "#B0BEC5",
    "--t-border-light": "#E4EAF4",
    "--t-shadow": "0 1px 3px rgba(60,80,120,0.08)",
    "--t-shadow-lg": "0 8px 24px rgba(60,80,120,0.14)",
  },
};
...
function applyTheme(mode) {
  const resolved =
    mode === "system" ? "light" : mode === "seasonal" ? getSeason() : mode;
...
const theme = {
  ...
  bgBadge: "var(--t-bg-badge)",
  text: "var(--t-text)",
  textSub: "var(--t-text-sub)",
  textLight: "var(--t-text-light)",
  textWhite: "var(--t-text-white)",
  primary: "var(--t-primary)",
  primaryLight: "var(--t-primary-light)",
  primaryDark: "var(--t-primary-dark)",
...
function LandingScreen({ isMobile, onStart }) {
  const features = [
    {
      icon: "📅",
      title: "일정",
      desc: "날짜별 타임테이블로 일정을 정리하고, 장소를 누르면 지도로 바로 연결됩니다.",
      img: `${process.env.PUBLIC_URL}/assets/onboarding/onboarding-1-itinerary.webp`,
    },
    {
      icon: "💰",
      title: "지출",
      desc: "결제수단별, 카테고리별로 지출을 기록하고 예산 대비 사용 현황을 확인하세요.",
      img: `${process.env.PUBLIC_URL}/assets/onboarding/onboarding-3-expense.webp`,
    },
    {
      icon: "✅",
      title: "체크리스트",
      desc: "지역별·동행 유형별 맞춤 체크리스트로 준비물을 놓치지 않게 안내합니다.",
      img: `${process.env.PUBLIC_URL}/assets/onboarding/onboarding-4-checklist.webp`,
    },
  ];
  ...
  return (
    <div
      style={{
        ...
        fontFamily:
          "'Pretendard Variable', 'Pretendard', -apple-system, sans-serif",
        padding: isMobile ? "32px 20px 40px" : "56px 40px",
      }}
    >
      <div style={{ maxWidth: isMobile ? "420px" : "980px", margin: "0 auto" }}>
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              서버 없이 내 기기와 내 구글 드라이브에만 저장되는, 가볍고 빠른
              여행 플래너입니다. 회원가입 없이 바로 시작하세요.
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <a
                href="https://play.google.com/store/apps/details?id=com.moritravel.planner"
                target="_blank"
          ...
          >
            <img
              src={`${process.env.PUBLIC_URL}/assets/landing/hero-mascot-packing.webp`}
              alt="여행 짐을 싸는 모리 캐릭터"
    ...
    >
      ...
      >
        <img
          src={
            mascotSrc ||
            `${process.env.PUBLIC_URL}/assets/icons/mascot-logo.png`
          }
          alt="모리"
          style={{
            width: "110px",
      ...
      >
        ...
        {!activeTripName && (
          ...
          >
            💡 웹(브라우저)에서 쓰던 데이터가 있다면, "기존 데이터 가져오기" →
            Google Drive에서 불러오기로 이어서 쓰실 수 있어요.
          </div>
        )}
      </div>
...
function TripSetupForm({ bgMode, onComplete, onBack }) {
  ...
  const update = (key, val) => {
    ...
    if (key === "accommodation") {
      setForm(prev => {
        if (nameEdited) return { ...prev, accommodation: val };
        const year = prev.tripStart ? new Date(prev.tripStart).getFullYear() : new Date().getFullYear();
        return { ...prev, accommodation: val, tripName: val ? `${year} ${val} 여행` : prev.tripName };
      });
      return;
    }
  ...
  const isValid =
    form.tripName && form.tripStart && form.tripEnd && selectedRegionId;

  const handleSubmit = () => {
    if (!isValid) return;
    const tripRegion =
      selectedRegionId === "domestic" ? "domestic" : "overseas";
    const cur = CURRENCIES.find(
      (c) => c.code === (selectedRegionObj?.currency || form.currency),
    );
    onComplete({
      ...DEFAULT_STATE,
      ...form,
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div>
            ...
            {selectedRegionObj && selectedRegionObj.cities.length > 0 && (
              <>
                ...
                >
                  추천 도시일 뿐이에요 — 다른 곳으로 간다면 아래에 직접 입력해도
                  됩니다
                </div>
              </>
            )}
            <input
              ...
              placeholder={
                selectedRegionObj?.accomPlaceholder ||
                "예: 신주쿠, 사카에 (안 적어도 됩니다)"
              }
              style={inputStyle}
            />
          ...
          {selectedRegionObj && (
            ...
            >
              💱 통화는 {selectedRegionObj.label}의 대표 통화({form.currency})로
              자동 설정됩니다 — 지출 탭에서 언제든 바꿀 수 있어요
            </div>
          )}
        </div>
...
function exportArchiveAsPDF(archive) {
  ...
  const totalKRW = (archive.expenses || []).reduce(
    (s, e) =>
      s + (e.currency === "KRW" ? e.amount || 0 : (e.amount || 0) * rate),
    0,
  );
  const itineraryRows = [...(archive.itinerary || [])]
    .sort(
      (a, b) =>
        a.day - b.day || ((a.startTime || "") < (b.startTime || "") ? -1 : 1),
    )
    .map(
      (s) => `<tr>
      <td>D${(s.day || 0) + 1}</td>
    ...
    .join("");
  const expenseRows = (archive.expenses || [])
    .map(
      (e) => `<tr>
  ...
  return (
    <ModalWrapper onClose={onClose}>
      ...
      {itinerary.length === 0 ? (
        ...
        itinerary.map((s) => (
          <div key={s.id} style={rowStyle}>
            <span style={{ flex: 1 }}>
              D{(s.day || 0) + 1} {s.startTime} — {s.title}
              {s.place ? ` (${s.place})` : ""}
            </span>
            <button onClick={() => removeSlot(s.id)} style={removeBtnStyle}>
              🗑️
            </button>
          </div>
        ))
      ...
      {expenses.length === 0 ? (
        ...
        expenses.map((e) => (
          <div key={e.id} style={rowStyle}>
            <span style={{ flex: 1 }}>
              {e.title} — {(e.amount || 0).toLocaleString()} {e.currency}
            </span>
            <button onClick={() => removeExpense(e.id)} style={removeBtnStyle}>
              🗑️
            </button>
          </div>
        ))
      ...
      <div style={{ display: "flex", gap: "10px", marginTop: "20px" }}>
        ...
        <button
          onClick={() =>
            onSave({ ...archive, tripName, review, itinerary, expenses })
          }
          style={{
            flex: 2,
            padding: "13px",
...
function GlobalSettingsScreen({
  ...
  const handleConnectDrive = async () => {
    ...
    try {
      ...
      setDriveMessage(
        "Google 계정이 연결되었습니다. 같은 세션에서는 다시 로그인하지 않아도 Drive 저장/불러오기를 쓸 수 있습니다.",
      );
    } catch (e) {
        ...
        >
            ...
            <div style={{ padding: "0 16px 14px" }}>
              <button
                ...
                style={{
                  ...
                  padding: "14px",
                  background:
                    driveStatus === "connected" ? theme.success : theme.bgCard,
                  color:
                    driveStatus === "connected" ? theme.textWhite : theme.text,
                  border: `1.5px solid ${driveStatus === "connected" ? theme.success : theme.border}`,
                  borderRadius: theme.radiusSm,
                  fontSize: "14px",
                  fontWeight: "700",
                  cursor: "pointer",
                  opacity: driveStatus === "connecting" ? 0.6 : 1,
                }}
              >
              ...
              {driveMessage && (
                <div
                  style={{
                    ...
                    fontSize: "12px",
                    color:
                      driveStatus === "error" ? theme.danger : theme.textSub,
                    lineHeight: 1.5,
                  }}
                >
                  {driveMessage}
              ...
              >
                여행을 시작하기 전에 미리 로그인해두면, 나중에 "데이터
                가져오기"에서 Drive 백업을 바로 불러올 수 있습니다.
              </div>
            </div>
          </div>
            ...
            >
              <div style={{ display: "flex", gap: "6px" }}>
                {[
                  ...
                  {
                    id: "seasonal",
                    label: `🍂 계절 (${getSeason() === "spring" ? "봄" : getSeason() === "summer" ? "여름" : getSeason() === "fall" ? "가을" : "겨울"})`,
                  },
                ].map((t) => (
                  <button
                    key={t.id}
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: "50%",
                        flexShrink: 0,
                        background: ct.bgImage
                          ? `url(${ct.bgImage}) center/cover`
                          : ct.bgColor || "#eee",
                    ...
                    <button
                      onClick={() => onToggleCustomTheme(ct)}
                      style={{
                        padding: "4px 10px",
                        fontSize: "11px",
                        fontWeight: "700",
          ...
          <div style={sectionStyle}>
            ...
            >
              ...
              <span style={{ fontSize: "16px", color: theme.textLight }}>
                ↗
              </span>
            </a>
          </div>
...
function ArchiveScreen({
  ...
  return (
    ...
    >
      ...
      <div
        style={{ padding: "16px 20px", maxWidth: "600px", margin: "0 auto" }}
      >
        {archives.map((arc, i) => (
          <div
            key={i}
          ...
          >
            ...
            >
              {arc.tripCard ? (
                ...
                >
                  {TRIP_REGIONS.find((r) => r.id === arc.selectedRegion)
                    ?.icon || (arc.tripRegion === "domestic" ? "🇰🇷" : "🌏")}
                </div>
              )}
              <div style={{ flex: 1 }}>
                <div
                ...
                >
                  {arc.tripStart && formatDate(arc.tripStart)} ~{" "}
                  {arc.tripEnd && formatDate(arc.tripEnd)}
                </div>
                {arc.review && (
                  <div
                    style={{
            ...
            {expanded === i && (
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() => exportArchiveAsPDF(arc)}
                    style={{
                      flex: 1,
                      padding: "9px",
                      fontSize: "12.5px",
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {APP_VERSION} · {phaseLabel[tripPhase]}
          </div>
        </div>
...
function getMapUrl(place, isOverseas) {
  const cleaned = place
    .replace(/[()（）[\]【】]/g, " ")
    .replace(/[^\w\s가-힣ぁ-んァ-ヶ一-龥a-zA-Z0-9]/g, "")
    .trim();
  if (!cleaned) return null;
  if (isOverseas)
    return `https://www.google.com/maps/search/${encodeURIComponent(cleaned)}`;
...
function parseCSV(text) {
  ...
  return lines
    ...
    .map((line, i) => {
      ...
      cols.push(current.trim());
      const rawTime =
        timeIdx >= 0 ? (cols[timeIdx] || "").toLowerCase().trim() : "";
...
function parseExcel(data) {
  ...
  try {
    ...
    const findKey = (row, candidates) => {
      ...
      for (const c of candidates) {
        const found = keys.find(
          (k) => k.toLowerCase().trim() === c.toLowerCase(),
        );
    ...
    return rows
      .map((row, i) => {
        const rawTime = timeKey
          ? String(row[timeKey]).toLowerCase().trim()
          : "";
        const startTime = timeMap[rawTime] || rawTime || "09:00";
        const rawDay = dayKey ? row[dayKey] : 0;
        const day =
          typeof rawDay === "string"
            ? (parseInt(rawDay.replace(/[^0-9]/g, "")) || 1) - 1
            : parseInt(rawDay) || 0;
        return {
  ...
  try {
    ...
    return rows
      .map((row, i) => {
        ...
        if (!text) return null;
        const doneRaw = doneKey
          ? String(row[doneKey] || "")
              .trim()
              .toUpperCase()
          : "";
        const done = ["O", "Y", "YES", "TRUE", "완료", "V", "✓"].includes(
          doneRaw,
        );
...
function parseExcelBudget(wb) {
  try {
    ...
    rows.forEach((row) => {
      ...
      const amount =
        parseFloat(String(row[amountKey] || "").replace(/[^0-9.]/g, "")) || 0;
      if (!label || amount <= 0) return;
      if (label.includes("총예산") && label.includes("현지"))
        totalLocal = amount;
      else if (label.includes("총예산")) totalKRW = amount;
      else if (BUDGET_CATS.includes(label))
        categories.push({ id: `bg_${label}`, name: label, planned: amount });
    });
    if (totalKRW === 0 && totalLocal === 0 && categories.length === 0)
      return null;
...
const BG_MODES = {
  light: {
    img: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-light.webp`,
    imgMobile: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-light-mobile.webp`,
    color: "#f4f7fd",
  },
  dark: {
    img: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-dark.webp`,
    imgMobile: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-dark-mobile.webp`,
    color: "#122143",
  },
  spring: {
    img: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-spring.webp`,
    imgMobile: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-spring-mobile.webp`,
    color: "#fce8f0",
  },
  summer: {
    img: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-summer.webp`,
    imgMobile: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-summer-mobile.webp`,
    color: "#ddeeff",
  },
  fall: {
    img: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-fall.webp`,
    imgMobile: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-fall-mobile.webp`,
    color: "#fdebd0",
  },
  winter: {
    img: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-winter.webp`,
    imgMobile: `${process.env.PUBLIC_URL}/assets/backgrounds/bg-winter-mobile.webp`,
    color: "#e8ecf0",
  },
};
...
function getThemeMascot(themeMode) {
  ...
  return (
    map[resolved] || `${process.env.PUBLIC_URL}/assets/icons/mascot-logo.png`
  );
}
...
function AppBackground({
  ...
  useEffect(() => {
    ...
    const imgToUse = customImg
      ? customImg
      : isNarrow && cfg.imgMobile
        ? cfg.imgMobile
        : cfg.img;
    if (customImg) {
...
function ParticleCanvas({ themeMode, enabled }) {
  ...
  const isActive =
    SEASONAL_THEMES.has(themeMode) &&
    ["spring", "summer", "fall", "winter"].includes(resolvedSeason);
  ...
  useEffect(() => {
    ...
    const COUNT =
      resolvedSeason === "winter" ? 28 : resolvedSeason === "summer" ? 16 : 22;
    const particles = Array.from({ length: COUNT }, (_, i) => ({
      x: Math.random() * W,
      y: Math.random() * H,
      size:
        resolvedSeason === "winter"
          ? 18.2 + Math.random() * 23.4
      ...
      drift:
        (Math.random() - 0.5) * (resolvedSeason === "winter" ? 0.08 : 0.18),
      driftPhase: Math.random() * Math.PI * 2,
      rot: Math.random() * Math.PI * 2,
      rotSpeed:
        (Math.random() - 0.5) * (resolvedSeason === "fall" ? 0.012 : 0.008),
      opacity:
        resolvedSeason === "winter"
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        const twinkle =
          resolvedSeason === "summer"
            ? p.opacity *
              (0.5 + 0.5 * Math.sin(frame * p.twinkleSpeed + p.twinklePhase))
            : p.opacity;
  ...
  return (
    <ModalWrapper onClose={onClose}>
      <div style={{ textAlign: "center" }}>
        ...
        >
          "{tripName || "진행중인 여행"}"이 아직 진행 중입니다.
          <br />새 여행을 만들려면 먼저 현재 여행을 마무리해주세요.
        </p>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                fontSize: "16px",
                color: rows.length <= 1 ? theme.borderLight : theme.textLight,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              }}
...
function AIPromptModal({ state, onClose }) {
  ...
  const regionLabel =
    TRIP_REGIONS.find((r) => r.id === state.selectedRegion)?.label || "";
  const destination =
    state.accommodation || regionLabel || state.tripName || "여행지";
  ...
  const days = nights + 1;
  const companionText = state.companionType
    ? `${state.companionType} ${state.companionCount || ""}명`
    : "";
...
6. 메모에는 입장료, 운영시간, 예약 필요 여부를 포함한다.`;
  ...
  return (
    <ModalWrapper onClose={onClose}>
      ...
      >
        아래 글을 복사해서, 평소 쓰시는 ChatGPT나 Claude 앱에 붙여넣어 보세요.
        AI가 답해준 표를 그대로 복사해서, 다음 화면에서 "텍스트로 가져오기"로
        붙여넣으면 일정에 바로 추가됩니다.
      </p>
      <textarea
        readOnly
      ...
      <button
        onClick={() => {
          navigator.clipboard
            ...
            .catch(() =>
              alert(
                "복사에 실패했습니다. 위 글을 직접 선택해서 복사해 주세요.",
              ),
            );
        }}
        style={{
...
function TextImportModal({ onImport, onClose }) {
  ...
  return (
    <ModalWrapper onClose={onClose}>
      ...
      >
        AI가 답해준 표(또는 줄글로 정리된 일정)를 그대로 복사해서 아래에
        붙여넣어 주세요.
      </p>
      <textarea
        value={text}
      ...
      <div
        style={{
          fontSize: "12.5px",
          color: parsed.length > 0 ? theme.success : theme.textLight,
          marginBottom: "14px",
        }}
      >
        {text.trim() === ""
  ...
  const handleFileUpload = (e) => {
    ...
    if (isExcel) {
      ...
      reader.onload = (ev) => {
        ...
        if (parsed.length === 0) {
          alert(
            "엑셀 파싱 실패: 첫 번째 시트에 '일정' 또는 'title' 열이 필요합니다.",
          );
          return;
        }
        setState((prev) => ({
      ...
      {days.length > 0 && (
        ...
        >
          {days.map(({ dayIndex, date }) => {
            ...
            const weekdays = ["일", "월", "화", "수", "목", "금", "토"];
            const daySlotsCount = state.itinerary.filter(
              (s) => s.day === dayIndex,
            ).length;
            return (
              <button
      ...
      <div style={{ padding: "0 20px 100px" }}>
        {daySlots.length > 0 ? (
          ...
          >
            {daySlots.map((slot, idx) => {
              const mapUrl = slot.place
                ? getMapUrl(slot.place, isOverseas)
                : null;
              return (
                <div
                  key={slot.id}
                ...
                >
                  {/* Visit Check */}
                  <button
                    onClick={() => handleToggleVisited(slot.id)}
                    style={{
                      width: "28px",
                      height: "28px",
                      borderRadius: "50%",
        ...
        <div style={{ marginTop: "24px" }}>
          ...
          <textarea
            ...
            onChange={(e) =>
              setState((prev) => ({ ...prev, tripMemo: e.target.value }))
            }
...
function ExpenseEditorModal({ expense, day, state, onSave, onClose }) {
  ...
  const METHODS = isDomestic
    ? ALL_METHODS.filter((m) => !m.isLocal)
    : ALL_METHODS;
  ...
  const isValid =
    form.title.trim() && form.amount && parseFloat(form.amount) > 0;
  ...
  const handleSave = () => {
    ...
    onSave({
      id:
        expense?.id ||
        `ex_${Date.now()}_${Math.random().toString(36).slice(2, 5)}`,
      day: expense?.day ?? day,
      title: form.title.trim(),
...
function SettlementView({ state }) {
  ...
  const totalBudget =
    (state.budget?.totalKRW || 0) + (state.budget?.totalLocal || 0) * rate;
  ...
  const allCats = [
    ...new Set([
      ...BUDGET_CATS.filter(
        (c) => budgetCats.find((b) => b.name === c) || byCat[c],
      ),
      ...Object.keys(byCat),
    ]),
  ];
    ...
    <div>
      ...
      <div style={sectionStyle}>
        <div style={titleStyle}>
          📊 카테고리별 {hasBudget ? "예산 vs 실사용" : "지출"}
        </div>
        {allCats.length > 0 ? (
          allCats.map((cat) => {
            const spent = Math.round(byCat[cat] || 0);
            const planned =
              budgetCats.find((b) => b.name === cat)?.planned || 0;
            const percent =
            ...
            return (
              ...
              >
                ...
                {!planned && totalKRW > 0 && (
                  ...
                  >
                    전체의 {Math.round(((byCat[cat] || 0) / totalKRW) * 100)}% ·
                    미편성
                  </div>
                )}
              </div>
    ...
    <div>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <div>
            ...
            <div
              style={{ fontSize: "16px", fontWeight: "800", color: "#1A1D23" }}
            >
          ...
          <div>
            ...
            <div
              style={{
                fontSize: "16px",
                fontWeight: "800",
                color: unallocated > 0 ? "#10B981" : "#9CA3AF",
              }}
            >
      ...
      >
        {segments
          ...
          .map((seg, i) => {
            const barPct =
              totalBudget > 0 ? (seg.amount / totalBudget) * 100 : 0;
            return (
              <div key={i}>
                <div
                  style={{
...
function BudgetEditorModal({ state, onSave, onClose }) {
  ...
  const totalBudget =
    (parseFloat(form.totalKRW) || 0) +
    (parseFloat(form.totalLocal) || 0) * rate;
  const allocated = BUDGET_CATS.reduce(
    (s, cat) => s + (parseFloat(form.cats[cat]) || 0),
    0,
  );
  ...
  const updateCat = (cat, rawVal) => {
    ...
    const othersTotal = BUDGET_CATS.reduce(
      (s, c) => (c === cat ? s : s + (parseFloat(form.cats[c]) || 0)),
      0,
    );
    ...
    setForm((p) => ({
      ...p,
      cats: { ...p.cats, [cat]: rawVal === "" ? "" : String(capped) },
    }));
  };

  const handleSave = () => {
    const categories = BUDGET_CATS.filter(
      (cat) => parseFloat(form.cats[cat]) > 0,
    ).map((cat) => ({
      id: `bg_${cat}`,
      name: cat,
      planned: parseFloat(form.cats[cat]) || 0,
    }));
    onSave({
  ...
  // Chart data
  const chartSegments = BUDGET_CATS.filter(
    (cat) => parseFloat(form.cats[cat]) > 0,
  ).map((cat) => ({
    label: cat,
    amount: parseFloat(form.cats[cat]) || 0,
    ratio:
      totalBudget > 0 ? (parseFloat(form.cats[cat]) || 0) / totalBudget : 0,
  }));
  if (unallocated > 0 && totalBudget > 0) {
    chartSegments.push({
      label: "미편성",
      amount: unallocated,
      ratio: unallocated / totalBudget,
    });
  }
    ...
    <ModalWrapper onClose={onClose}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {!isDomestic && (
          <div>
            <label style={labelStyle}>
              현지통화 예산 ({curSymbol} {state.currency})
            </label>
            <AmountInput
              value={form.totalLocal}
          ...
          <>
            ...
            >
              <div style={{ textAlign: "left" }}>
                ...
                >
                  편성 {Math.round(allocated).toLocaleString()}원 · 미편성{" "}
                  {Math.round(Math.max(0, unallocated)).toLocaleString()}원
                </div>
              </div>
              <span
              ...
              >
                ...
                <div
                  style={{
                    ...
                    alignItems: "center",
                    padding: "10px 12px",
                    background: unallocated > 0 ? "#ECFDF5" : theme.bgBadge,
                    borderRadius: theme.radiusSm,
                    marginBottom: "14px",
                  }}
                >
...
function ExpenseTab({ state, setState }) {
  ...
  const confirmDelete = () => {
    ...
    setState((prev) => ({
      ...prev,
      expenses: prev.expenses.filter((e) => e.id !== deleteTarget.id),
    }));
    setDeleteTarget(null);
  };
    ...
    <div>
      ...
      {state.tripRegion === "overseas" && (
        <div style={{ margin: "16px 20px 0" }}>
          <button
            onClick={() => setCurrencyBarOpen((v) => !v)}
            style={{
              width: "100%",
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            >
              💱 {state.currency} · 1{state.currency} ={" "}
              {formatRateLabel(state.rate)}
            </span>
          ...
          {currencyBarOpen && (
            ...
            >
              <select
                ...
                onChange={(e) => {
                  ...
                  setState((prev) => ({
                    ...prev,
                    currency: code,
                    rate: cur?.defaultRate || prev.rate,
                  }));
                  setRateStatus("idle");
              ...
              />
              <button
                onClick={() => refreshRate(state.currency)}
                ...
                style={{
                  ...
                  fontSize: "15px",
                  opacity: rateStatus === "loading" ? 0.5 : 1,
                }}
              >
                {rateStatus === "loading" ? "⏳" : "🔄"}
              </button>
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontSize: "15px", fontWeight: "800", color: theme.text }}
          >
            {totalBudget > 0
              ? `${Math.round(totalBudget).toLocaleString()}원`
              : "미설정"}
      ...
      >
        {days.map((d) => {
          ...
          const label =
            d === -1 ? "출발전" : d === 999 ? "정산" : `${d + 1}일차`;
          const count =
            d === 999
              ? 0
              : (state.expenses || []).filter((e) => e.day === d).length;
          return (
            <button
              key={d}
...
const PHASE_ITEMS = {
  plan: {
    ...
    china: [
      { id: "plc1", text: "중국 비자·무비자 정책 확인 (정책 변동 잦음)" },
    ],
    north_america: [
      { id: "plna1", text: "ESTA(미국) 또는 eTA(캐나다) 신청 확인" },
    ],
    latin_america: [
  ...
  confirm: {
    ...
    oceania: [
      { id: "cfo1", text: "자외선 차단제 준비 (자외선 강도 매우 높음)" },
    ],
  ...
  depart: {
    common: [
      ...
      {
        id: "dp5",
        text: "보조배터리 충전 완료 — 2개 이내, 기내 반입만 가능, 단자 보호 필수 (기내 사용 금지)",
      },
      { id: "dp6", text: "짐 패킹 완료" },
      { id: "dp7", text: "상비약 챙기기" },
    ...
    domestic: [
      {
        id: "dpd1",
        text: "신분증(주민등록증·운전면허증) 챙기기 — 항공권 발권·렌터카 시 필수",
      },
    ],
...
function CheckTab({ state, setState }) {
  ...
  useEffect(() => {
    ...
    if (daysLeft > 14)
      setOpenPhase(completedPhases["plan"] ? "confirm" : "plan");
    else if (daysLeft > 0)
      setOpenPhase(completedPhases["confirm"] ? "depart" : "confirm");
  ...
  const getPhaseItems = (phaseId) => {
    ...
    if (selectedRegion !== "domestic" && data.overseas)
      items.push(...data.overseas);
    if (selectedRegion && selectedRegion !== "none" && data[selectedRegion])
      items.push(...data[selectedRegion]);
    if (companionType && data[companionType])
      items.push(...data[companionType]);
    return items;
  };
  ...
  const setRegion = (id) =>
    setState((prev) => ({ ...prev, selectedRegion: id }));
  ...
  const addShopItem = () => {
    ...
    setState((prev) => ({
      ...
      shoppingList: [
        ...(prev.shoppingList || []),
        { id: `sl_${Date.now()}`, text: newShopItem.trim(), done: false },
      ],
    }));
    setNewShopItem("");
  ...
  return (
    <div style={{ paddingBottom: "100px" }}>
      ...
      >
        ✈️ 기내반입 주의: 액체 100ml↑ 금지 · 보조배터리 2개 이내·위탁 금지·기내
        사용 금지(2026.4.20~) · EVE 진통제 한국 반입 금지
        <button
      ...
      <div style={{ display: "flex", gap: "8px", padding: "12px 20px 0" }}>
        {[
          {
            id: "checklist",
            label: `✅ 체크리스트 (${totalChecked}/${allItems.length})`,
          },
          {
            id: "shopping",
        ...
        {activeSection === "checklist" ? (
          <>
                    ...
                    <button
                      ...
                      onClick={() => {
                        setState((prev) => ({
                          ...
                          companionCount: c.fixed
                            ? c.count
                            : prev.companionCount || 2,
                        }));
                      }}
                      style={{
                        padding: "10px 6px",
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      setState((prev) => ({
                        ...prev,
                        companionCount: Math.max(
                          2,
                          (prev.companionCount || 2) - 1,
                        ),
                      }))
                    }
                    style={{
                  ...
                  <button
                    onClick={() =>
                      setState((prev) => ({
                        ...prev,
                        companionCount: (prev.companionCount || 2) + 1,
                      }))
                    }
                    style={{
                      width: "30px",
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                💡 선택하면 지역별 추가 준비물이 표시됩니다 (공통 항목은 항상
                포함)
              </div>
              <div
                style={{
              ...
              >
                {REGIONS.map((r) => {
                  ...
                  return (
                    <button
                      key={r.id}
                      onClick={() => setRegion(isActive ? "" : r.id)}
                      style={{
                        padding: "12px 4px",
                        border: `1.5px solid ${isActive ? theme.primary : theme.border}`,
                        borderRadius: theme.radiusSm,
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        >
                          {isDone ? "완료" : `${checked}/${items.length} 체크`}{" "}
                          · {phase.desc}
                        </div>
                      </div>
                      {/* Progress mini bar */}
                        ...
                        >
                          {isDone ? (
                            ...
                            >
                              {allChecked
                                ? "✅ 이 단계 완료!"
                                : `🔲 미완료 항목이 ${items.length - checked}개 있음 · 그래도 완료 처리`}
                            </button>
                          )}
                        </div>
                      </div>
          ...
          <div>
            ...
            >
              🪣 <strong>여행 버킷</strong>은 사고 싶은 것, 챙겨야 할 것, 먹어볼
              것 등<br />
            ...
            {shoppingList.length > 0 && (
              ...
              >
                {shoppingList.filter((s) => s.done).length}/
      ...
      {showProhibited && (
        <ModalWrapper onClose={() => setShowProhibited(false)}>
          ...
          >
            ...
            <button
              onClick={() => setShowProhibited(false)}
              style={{
                background: "none",
                border: "none",
                fontSize: "22px",
          ...
          >
            📅 2026년 4월 최신 기준 · 항공사·노선별 규정이 다를 수 있으니 탑승
            전 항공사에서 최종 확인
          </div>
          <div
...
const DRIVE_CLIENT_ID =
  "840168983675-g6o8fmmnrnmbmp1u7soa48jgh8v2rsu2.apps.googleusercontent.com";
        ...
        reject(
          new Error(
            "Google 인증 스크립트 로드 실패.\n\n" +
              ...
              '<script src="https://accounts.google.com/gsi/client" async defer></scri' +
              "pt>",
          ),
        );
...
async function ensureDriveToken() {
  ...
  if (!window.google?.accounts?.oauth2) {
    throw new Error(
      "Google 인증 모듈을 불러오지 못했습니다. 페이지를 새로고침해 주세요.",
    );
  }
...
function useDrive(state, setState) {
  ...
  const [lastSynced, setLastSynced] = useState(
    localStorage.getItem("drive_last_synced") || "",
  );
...
function applyCustomTheme(ct) {
  ...
  document.body.style.background = ct.bgImage
    ? "transparent"
    : c.bg || "#FAFAF8";
}
...
function CustomParticleCanvas({ theme: ct }) {
  ...
  useEffect(() => {
    ...
    // 이미지 로드
    const imgs = ct.particles.map((src) => {
      const i = new Image();
      i.src = src;
      return i;
    });
...
function CustomThemeEditorModal({ editTheme, onSave, onClose }) {
  ...
  const handleBgUpload = (e) => {
    ...
    if (file.size > 2 * 1024 * 1024) {
      setSizeWarning("배경 이미지는 2MB 이하로 올려주세요.");
      return;
    }
    setSizeWarning("");
    const reader = new FileReader();
  ...
  const handleParticleUpload = (e) => {
    ...
    if (form.particles.length + files.length > 3) {
      setSizeWarning("파티클은 최대 3개까지 가능합니다.");
      return;
    }
    setSizeWarning("");
    files.forEach((file) => {
      if (file.size > 500 * 1024) {
        setSizeWarning("파티클 이미지는 500KB 이하로 올려주세요.");
        return;
      }
      const reader = new FileReader();
      reader.onload = (ev) =>
        setForm((p) => ({
          ...p,
          particles: [...p.particles, ev.target.result],
        }));
      reader.readAsDataURL(file);
    });
    e.target.value = "";
  ...
  return (
    <ModalWrapper onClose={onClose}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "6px" }}>
              {[
                ...
                <button
                  key={t.id}
                  onClick={() => update("bgFit", t.id)}
                  style={{
                    flex: 1,
                    padding: "9px 4px",
                    background:
                      form.bgFit === t.id ? theme.primary : theme.bgCard,
                    color:
                      form.bgFit === t.id ? theme.textWhite : theme.textSub,
        ...
        <div>
          <label style={labelStyle}>
            마스코트 이미지 (선택, PNG 투명배경, 500KB 이하)
          </label>
          {form.mascotImage ? (
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <img
                src={form.mascotImage}
                alt="mascot"
                style={{
                  width: "64px",
                  height: "64px",
              ...
              />
              <button
                onClick={() => update("mascotImage", null)}
                style={{
                  padding: "6px 12px",
                  background: theme.danger,
                  color: "#fff",
            ...
            <>
              <input
                ...
                onChange={(e) => {
                  ...
                  const reader = new FileReader();
                  reader.onload = (ev) =>
                    update("mascotImage", ev.target.result);
                  reader.readAsDataURL(file);
                  e.target.value = "";
                }}
                style={{ display: "none" }}
        ...
        <div>
          <label style={labelStyle}>
            파티클 이미지 (선택, PNG 투명배경, 최대 3개, 각 500KB 이하)
          </label>
              ...
              <div key={i} style={{ position: "relative" }}>
                ...
                <button
                  onClick={() =>
                    setForm((p) => ({
                      ...p,
                      particles: p.particles.filter((_, j) => j !== i),
                    }))
                  }
                  style={{
                    position: "absolute",
            ...
            {form.particles.length < 3 && (
              <>
                <input
                  ...
                  accept="image/png"
                  multiple
                  onChange={handleParticleUpload}
                  style={{ display: "none" }}
                />
                <button
                  onClick={() => particleRef.current?.click()}
                  style={{
                    width: "56px",
                    height: "56px",
                    border: `1.5px dashed ${theme.border}`,
  ...
  return (
    <ModalWrapper onClose={onClose}>
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            {[
              ...
              <button
                key={opt.val}
                onClick={() => update("tripRegion", opt.val)}
                style={{
                  flex: 1,
                  padding: "11px",
                  ...
                  borderRadius: theme.radiusSm,
                  background:
                    form.tripRegion === opt.val
                      ? theme.primaryLight
                      : theme.bgCard,
                  color:
                    form.tripRegion === opt.val ? theme.primary : theme.text,
                  fontSize: "14px",
                  fontWeight: "600",
                  cursor: "pointer",
                }}
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: "6px" }}>
                <input
                  ...
                  value={form.rate}
                  onChange={(e) =>
                    update("rate", e.target.value.replace(/[^0-9.]/g, ""))
                  }
                  placeholder="예: 9.2"
                  style={inputStyle}
                />
      ...
      <div style={{ display: "flex", gap: "10px", marginTop: "24px" }}>
        ...
        <button
          onClick={() =>
            onSave({ ...state, ...form, rate: parseFloat(form.rate) || 0 })
          }
          style={{
            flex: 2,
            padding: "14px",
...
function ImportShareModal({ data, onOverwrite, onNew, onCancel }) {
  return (
    <ModalWrapper onClose={onCancel}>
      ...
      <p
        style={{ fontSize: "14px", color: theme.textSub, marginBottom: "20px" }}
      >
        <b>{data.tripName}</b> ({data.tripStart} ~ {data.tripEnd}) 일정을
        받았습니다. 어떻게 저장할까요?
      </p>
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        <button
      ...
      {archives.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {archives.map((arc, i) => {
            ...
            const totalSpent = (arc.expenses || []).reduce(
              (s, e) => s + (e.currency === "KRW" ? e.amount : e.amount * rate),
              0,
            );
            return (
              <div
...
function SettingsTab({
  ...
  const handleCardUpload = (e) => {
    ...
    const reader = new FileReader();
    reader.onload = (ev) =>
      setState((prev) => ({ ...prev, tripCard: ev.target.result }));
    reader.readAsDataURL(file);
    e.target.value = "";
  };
  ...
  const handleShare = async () => {
    ...
    const file = new File([blob], `${state.tripName || "여행"}_일정.json`, {
      type: "application/json",
    });
    ...
    const downloadFallback = () => {
      ...
      alert(
        "공유가 지원되지 않아 파일을 다운로드했습니다. 다운로드 폴더를 확인해주세요.",
      );
    };
  ...
  const handleFileUpload = (e) => {
    ...
    if (isExcel) {
      ...
      reader.onload = (ev) => {
        ...
        setState((prev) => ({
          ...prev,
          itinerary: parsed.length
            ? [
                ...prev.itinerary,
                ...parsed.map((s) => ({ ...s, id: generateId() })),
              ]
            : prev.itinerary,
          shoppingList: bucket.length
            ? [...(prev.shoppingList || []), ...bucket]
            : prev.shoppingList || [],
        ...
        try {
          ...
          if (data.itinerary) {
            setState((prev) => ({
              ...
              itinerary: [
                ...prev.itinerary,
                ...data.itinerary.map((s) => ({ ...s, id: generateId() })),
              ],
            }));
  ...
  return (
    <div style={{ padding: "16px 20px 100px" }}>
      ...
      <div style={sectionStyle}>
        ...
        >
          {[
            ...
            {
              label: "기간",
              value: `${formatDate(state.tripStart)} ~ ${formatDate(state.tripEnd)}`,
            },
            {
              label: "지역",
              value: state.tripRegion === "domestic" ? "🇰🇷 국내" : "🌏 해외",
            },
      ...
      <div style={sectionStyle}>
        ...
        {state.tripCard && (
          <div style={{ padding: "0 16px 12px" }}>
            <img
              src={state.tripCard}
              alt="trip card"
              style={{ width: "100%", borderRadius: theme.radiusSm }}
            />
          </div>
        )}
        <input
        ...
        {state.tripCard && (
          <button
            onClick={() => setState((prev) => ({ ...prev, tripCard: null }))}
            style={{
              ...rowStyle,
              borderBottom: "none",
              borderTop: `1px solid ${theme.borderLight}`,
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  padding: "9px 4px",
                  background:
                    theme_mode === t.id ? theme.primary : theme.bgCard,
        ...
        {customThemes.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {customThemes.map((ct, i) => {
              const active =
                getActiveCustomTheme(customThemes)?.id === ct.id || ct.isActive;
              const today = new Date();
              today.setHours(0, 0, 0, 0);
              const isAutoActive =
                ct.autoApply &&
                ct.startDate &&
                ct.endDate &&
                today >= new Date(ct.startDate + "T00:00:00") &&
                today <= new Date(ct.endDate + "T00:00:00");
              return (
                <div
                  key={ct.id}
                  style={{
        ...
        {[
          {
            ...
            label: "엑셀 양식 다운로드",
            desc: "일정 입력 템플릿 (.xlsx)",
            action: handleExcelTemplate,
          },
          {
            icon: "📤",
            label: "파일 업로드",
            desc: "엑셀 / CSV / JSON 일정 가져오기",
          ...
          <button
            ...
            style={{
              ...rowStyle,
              borderBottom:
                i < arr.length - 1 ? `1px solid ${theme.borderLight}` : "none",
            }}
          >
      ...
      <div style={sectionStyle}>
        ...
        <div style={{ display: "flex", padding: "0 12px 14px", gap: "8px" }}>
          ...
          >
            <span style={{ fontSize: "20px" }}>☁️</span>
            <span
              style={{ fontSize: "13px", fontWeight: "700", color: theme.text }}
            >
              Drive 저장
            </span>
        ...
        >
          💡 Drive 저장 시 Google 계정 로그인이 필요합니다.
          <br />
          저장 파일명: {DRIVE_FILE_NAME}
          <br />
          🌐 다른 브라우저나 기기에서 쓰던 데이터는 위 "Drive 불러오기"로 옮길
          수 있어요.
          <br />
          <span style={{ color: theme.textLight }}>
            ⚙️ 배포 환경에서는 index.html &lt;head&gt;에
            <br />
    ...
    return (
      <div>
        ...
        {dday && (
          ...
          >
            ...
            <div style={{ fontSize: "13px", marginTop: "4px", opacity: 0.8 }}>
              {state.tripStart && formatDate(state.tripStart)} ~{" "}
              {state.tripEnd && formatDate(state.tripEnd)}
            </div>
          </div>
        )}
        {/* 여행 정보 */}
        ...
        >
          ...
          {state.accommodation && (
            <InfoRow label="숙소" value={state.accommodation} />
          )}
        </div>
        {/* 여행 메모 미리보기 */}
        {state.tripMemo && (
    ...
    return (
      <div>
        ...
        >
          ...
          <InfoRow
            label="총 지출"
            value={`${Math.round(totalSpent).toLocaleString()}원`}
            color={theme.danger}
          />
          {totalBudget > 0 && (
            <>
              <InfoRow
                label="잔액"
                value={`${Math.round(remaining).toLocaleString()}원`}
                color={remaining >= 0 ? theme.success : theme.danger}
              />
            ...
            {Object.entries(byCat)
              ...
              .map(([cat, amt]) => (
                <InfoRow
                  key={cat}
                  label={cat}
                  value={`${Math.round(amt).toLocaleString()}원`}
                />
              ))}
          </div>
        )}
        ...
        >
          ...
          {PHASES_INFO.map((p) => {
            ...
            if (
              ...
              state.selectedRegion !== "domestic" &&
              data.overseas
            )
              items.push(...data.overseas);
            if (state.selectedRegion && data[state.selectedRegion])
              items.push(...data[state.selectedRegion]);
            if (state.companionType && data[state.companionType])
              items.push(...data[state.companionType]);
            const checked = items.filter((i) => checkStates[i.id]).length;
            const pct =
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: "13px",
                      fontWeight: "700",
                      color: pct === 100 ? theme.success : theme.textSub,
                    }}
                  >
    ...
    return (
      <div>
        ...
        >
          ...
          <InfoRow
            label="여행 기록"
            value={`${state.archives?.length || 0}개`}
          />
          {state.lastSaved && (
            <InfoRow
              label="마지막 저장"
              value={new Date(state.lastSaved).toLocaleString("ko-KR", {
                month: "numeric",
                day: "numeric",
                hour: "2-digit",
                minute: "2-digit",
...
export default function App() {
  ...
  const handleToggleCustomTheme = (ct) => {
    const updated = customThemes.map((t) => ({
      ...t,
      isActive: t.id === ct.id ? !t.isActive : false,
    }));
    setCustomThemes(updated);
    saveCustomThemes(updated);
...
// 웰컴 화면 진입 시 온보딩 자동 표시 (아직 안 본 사용자만)
  ...
  const tripPhase = state
    ...
    : "before";
  const currentTab =
    activeTab || (tabOrder.length > 0 ? tabOrder[0] : "itinerary");
  ...
  if (screen === "landing") {
    return (
      <LandingScreen isMobile={isMobile} onStart={() => setScreen("welcome")} />
    );
  }
    ...
    return (
      <>
        ...
        {showTripInProgress && (
          <TripInProgressModal
            tripName={state?.tripName}
            onClose={() => setShowTripInProgress(false)}
            onGoToTrip={() => {
              setShowTripInProgress(false);
              setScreen("main");
            }}
          />
        )}
      ...
      case "settings":
        return (
          <SettingsTab
            ...
            handleDriveLoad={handleDriveLoad}
  ...
  return (
    ...
    >
      {!activeCustomTheme && (
        <AppBackground
          mode={resolveBgMode(appThemeMode)}
          bgFit="tile"
          mascotSrc={getThemeMascot(appThemeMode)}
        />
      )}
      ...
      <div style={{ flex: 1, minWidth: 0, maxWidth: "100%" }}>
        {/* Mobile Header */}
        {isMobile && state && (
          <MobileHeader state={state} onGoHome={handleGoHome} />
        )}
